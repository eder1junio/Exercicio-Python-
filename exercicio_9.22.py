#Ao ler  ou grava  uma nova lista,verifique se agenda atual já foi gravada. Você pode usar uma variavel para controlar quando alista foi alterada(novo,altera, apagar)
#e reinicializar esse valor quando ela fo lida ou gravada.
